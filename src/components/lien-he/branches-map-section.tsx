    ...
    <section
        ...
        <div className='custom-container px-4 py-12 sm:px-6 lg:py-16'>
            <header className='flex flex-col gap-y-2 mx-auto max-w-2xl text-center'>
                ...
                <p className='font-sans ext-mobile-body-1 text-[#717171] sm:text-body-1 font-normal'>
            ...
            <div className='mt-10 overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-neutral-200/80 lg:mt-12'>
                <div className='grid grid-cols-1 lg:grid-cols-2 lg:items-stretch'>
                                ...
                                <ul className='mt-4 space-y-3'>
                                    <li className='flex gap-2'>
                                        <MapPinIcon
                                            ...
                                            aria-hidden
                                        />
                                        <span className='text-mobile-body-2 font-normal text-neutral-700 sm:text-body-2'>
                    ...
                    <div className='relative min-h-70 min-w-0 bg-neutral-100 lg:min-h-105'>
                        <iframe
                            title='Bản đồ vị trí'
