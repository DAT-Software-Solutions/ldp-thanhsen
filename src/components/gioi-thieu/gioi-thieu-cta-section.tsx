      ...
      <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-12 xl:gap-16">
        <div className="flex flex-col items-start text-left">
          <h2
            ...
            className="font-serif text-mobile-heading-2 font-bold leading-snug tracking-tight text-[#2D3436] sm:text-heading-3 lg:text-heading-2 lg:leading-tight"
          >
            Liên hệ với chúng tôi để được nhận tư vấn về mọi vấn đề liên quan
            đến pháp luật từ chuyên gia
          </h2>
          <Link
            href={CTA_HREF}
            className={`mt-6 inline-flex min-h-11 items-center justify-center rounded-lg bg-primary px-6 py-3 text-sm font-medium text-white transition-opacity hover:opacity-95 sm:min-h-12 sm:text-base ${btnFocus}`}
          >
            Tìm hiểu thêm
          </Link>
        </div>
