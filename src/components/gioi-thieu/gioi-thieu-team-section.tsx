...
const TeamMemberCard = () => (
  <article className="flex flex-col items-center text-center">
    ...
    <p className="mt-1 text-mobile-body-2 text-[#666666] sm:text-body-3">Luật sư</p>
  </article>
);
  ...
  <section className="bg-[#F5F6F7] py-12 sm:py-14 lg:py-20">
    <div className="custom-container px-4 sm:px-6">
      <header className="mx-auto max-w-3xl text-center">
        <h2 className="font-serif text-mobile-heading-3 font-normal leading-snug text-[#2D3436] sm:text-heading-3 sm:leading-[1.2] lg:text-heading-2">
          <span className="block sm:inline">Đội ngũ luật sư tại </span>
          <span className="font-bold text-primary">Thành Sen Group</span>
        </h2>
        <p className="mx-auto mt-4 max-w-2xl text-mobile-body-1 leading-snug text-[#555555] sm:mt-5 sm:text-body-2 sm:leading-normal">
          Chúng tôi cung cấp một đội ngũ có chuyên môn sâu và kinh nghiệm thực tiễn phong phú
        </p>
      </header>
