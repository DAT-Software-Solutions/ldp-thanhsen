...
export const HOME_ABOUT_IMAGE_SRC_DESKTOP = "/images/thanhsen_gioi-thieu.png";

/** Ảnh thẻ nổi bật section báo chí Home */
export const HOME_PRESS_FEATURED_IMAGE_SRC = "/images/introduction-team.jpg";
